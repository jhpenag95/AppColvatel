...
<main>
    <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="number" min="1" max="2" step="1" value="<?php echo $cantidad; ?>" size="5" id="cantidad_<?php echo $_id; ?>" onchange=""></td>
                        <td>
                            <div id="subtotal_<?php echo $_id; ?>" name="subtotal[]"><?php echo MONEDA .number_format($subtotal, 2, '.', ','); ?></div>
                        </td>
                        <td><a href="#" id="eliminar" class="btn btn-warning btn-sm" data-bs-id="<?php echo $_id;?>" data-bs-toogle="modal" data-bs-target="Elimina Modal">Elimiar</a></td>
                    </tr>
                    <?php 
                            }
                        }
        ...
        <div class="row">
          <div class="col-md-3 ms-md-auto"><button class="btn btn-primary btn-lg">Realizar Cotización</button></div>             
        </div>
    </div>
  </main>
